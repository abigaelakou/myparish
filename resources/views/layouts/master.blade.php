                    ...
                    <div> <a class="toggle-sidebar" href="#"> <i class="iconly-Category icli"> </i></a>
                        <div class="d-flex align-items-center gap-2 ">
                            <h4 class="f-w-600">Bienvenu {{ Auth::user()->name }}</h4><img class="mt-0"
                                src="../assets/images/hand.gif" alt="hand-gif">
                        </div>
                    </div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="flex-grow-1">
                                                                        <div class="common-space user-id w-100">
                                                                            <div class="common-space w-100"> <a
                                                                                    class="f-w-500 f-12"
                                                                                    href="private-chat.html">Courtney C.
                                                                                    Strang</a></div>
                                                                        </div>
                                        ...
                                        <div class="card-body total-project border-b-primary border-2"><span
                                            ...
                                            <div class="project-details">
                                                <div class="project-counter">
                                                    <h2 class="f-w-600">1,523</h2><span class="f-12 f-w-400">(This
                                                        month)</span>
                                                </div>
                                ...
                                <div class="col-xl-3 col-sm-6">
                                    <div class="card o-hidden small-widget">
                                        <div class="card-body total-Progress border-b-warning border-2"> <span
                                            ...
                                            <div class="project-details">
                                                <div class="project-counter">
                                                    <h2 class="f-w-600">836</h2><span class="f-12 f-w-400">(This month)
                                                    </span>
                                                </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><span class="f-w-500 f-light d-block f-12 mb-1">App
                                                                    Design</span><a class="f-w-500 f-14"
                                                                    href="product.html">NFT Illustration...</a></td>
                                                            <td> <span class="f-w-500 f-light d-block f-12 mb-1">Arlene
                                                        ...
                                                        <tr>
                                                            <td><span class="f-w-500 f-light d-block f-12 mb-1">Desktop
                                        ...
                                        <div class="card-body pt-0 row important-project">
                                                ...
                                                <div class="projectlist-card">
                                                    <div class="projectlist">
                                                        <div class="project-data"><img class="nft-img img-fluid"
                                                                src="../assets/images/dashboard-2/category/1.png"
                                                                alt="nft">
                                                            <div> <a class="f-14 f-w-500 d-block"
                                                                    href="product.html">Net Banking App</a><span
                                                                    class="f-light f-12 f-w-500">Client: Jordan</span>
                                                            </div>
                                                        </div><span
                                                            class="badge rounded-pill badge-primary bg-light-primary">7
                                                            Days Left</span>
                                                    </div>
                                                    <div class="project-date"><span class="f-light f-12 f-w-500">10 Oct,
                                                            2024 </span><span class="f-light f-12 f-w-500">15 Nov, 2024
                                                        </span></div>
                                                    <div class="range_4">
                                                    ...
                                                    <div class="project-comment">
                                                        ...
                                                        <div class="project-comment-icon">
                                                            <div class="project-link">
                                                                <svg>
                                                                    <use
                                                                        href="../assets/svg/icon-sprite.svg#messages-2">
                                                                    </use>
                                                                </svg><span>18 </span>
                                                            </div>
                                                            <div class="project-link">
                                                                <svg>
                                                                    <use href="../assets/svg/icon-sprite.svg#paperclip">
                                                                    </use>
                                                                </svg><span>2 </span>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="project-meeting-details">
                                                        <div class="project-meeting"><span
                                                                ...
                                                                class="f-light f-12 f-w-500">Next Meeting </span></div>
                                                        <div class="project-meeting-time"><a class="f-14 f-w-500 "
                                                                href="calendar-basic.html">2 Nov 23,10:00 AM</a><a
                                                                class="f-14 f-w-500 " href="calendar-basic.html">8 Nov
                                                                23,09:45 AM</a></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 box-col-6">
                                                <div class="projectlist-card">
                                                    <div class="projectlist">
                                                        <div class="project-data"><img class="nft-img img-fluid"
                                                                src="../assets/images/dashboard-2/category/2.png"
                                                                alt="nft">
                                                            <div><a class="f-14 f-w-500 d-block" href="product.html">NFT
                                                                    Website</a><span class="f-light f-12 f-w-500">Client
                                                                    : Albert Flores</span></div>
                                                        </div><span
                                            ...
                                            <div class="col-xl-4 box-col-none marketing-app-card">
                                                <div class="projectlist-card">
                                                    <div class="projectlist">
                                                        <div class="project-data"> <img class="nft-img img-fluid"
                                                                src="../assets/images/dashboard-2/category/3.png"
                                                                alt="nft">
                                                            <div><a class="f-14 f-w-500 d-block"
                                                                    href="product.html">Marketing App </a><span
                                                                    class="f-light f-12 f-w-500">Client : Jane Cooper
                                                                </span></div>
                                                        </div><span
                                                            class="badge rounded-pill badge-primary bg-light-primary">31
                                                            Days Left</span>
                                                    </div>
                                                    <div class="project-date"><span class="f-light f-12 f-w-500">01 Nov,
                                                            2024 </span><span class="f-light f-12 f-w-500">18 Dec, 2024
                                                        </span></div>
                                                    <div class="range_4">
                                                        <div class="slider-container">
                                                            <div class="slider_thumb range-slider_thumb"></div>
                                                            ...
                                                            <div class="avatars">
                                                                <div class="customers d-inline-block avatar-group">
                                                                    <ul>
                                                                        ...
                                                                        <li class="d-inline-block"><img
                                                                                class="img-25 rounded-circle"
                                                                                src="../assets/images/user/26.png"
                                                                                alt=""></li>
                                                                        <li class="d-inline-block"><img
                                                                                class="img-25 rounded-circle"
                                                                                src="../assets/images/user/27.png"
                                                                                alt=""></li>
                                                                        <li class="d-inline-block"> <img
                                                                                class="img-25 rounded-circle"
                                                                                src="../assets/images/user/28.png"
                                                                                alt=""></li>
                                                                        <li class="d-inline-block">
                                                    ...
                                                    <div class="project-meeting-details">
                                                        <div class="project-meeting"> <span
                                                                ...
                                                                class="f-light f-12 f-w-500">Next Meeting </span></div>
                                                        <div class="project-meeting-time"> <a class="f-14 f-w-500 "
                                                                href="calendar-basic.html">6 Nov 23,2:56 PM</a><a
                                                                class="f-14 f-w-500 " href="calendar-basic.html">10 Nov
                                                                23, 7:12 AM</a></div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="project-comment  d-flex gap-2">
                                                                    <div class="radial-chart-wrap">
                                                                        <div class="widgetsChart" id="widgetsChart1">
                                                                        </div>
                                                                    </div>
                                                                    <div> <a class="f-w-500 f-14 "
                                                                            href="product.html">Pet App Design</a>
                                                                        <div class="project-comment-icon">
                                                                            <div class="project-link">
                                                                                <svg>
                                                                                    <use
                                                                            ...
                                                                            <div class="project-link">
                                                                                <svg>
                                                                                    <use
                                                                                        href="../assets/svg/icon-sprite.svg#paperclip">
                                                                                    </use>
                                                                                </svg><span
                                                            ...
                                                            <td>
                                                                <div class="product-sub"><a class="f-w-500 f-14 "
                                                                        href="product.html">Darrell Steward</a><span
                                                                        class="f-w-500 f-light f-12 d-block">darrells@example.com</span>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="product-sub"><a class="f-w-500 f-14 "
                                                                        href="product.html">15 Nov, 2024</a><span
                                                                        class="f-w-500 f-light f-12 d-block">8 Days
                                                                        Left</span></div>
                                                            </td>
                                                            <td>
                                                                <div class="product-sub"><a class="f-w-500 f-14 "
                                                                        href="product.html">Team Roha</a><span
                                                                ...
                                                                <div class="product-sub">
                                                                    <div class="dropdown">
                                                                        <div id="dropdownMenuButtonicon11"
                                                                            ...
                                                                            <svg class="invoice-icon">
                                                                                <use
                                                                                    href="../assets/svg/icon-sprite.svg#more-horizontal">
                                                                                </use>
                                                                            </svg>
                                                                        </div>
                                                                        <div class="dropdown-menu dropdown-menu-end"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="project-comment  d-flex gap-2">
                                                                    <div class="radial-chart-wrap">
                                                                        <div class="widgetsChart" id="widgetsChart2">
                                                                        </div>
                                                                    </div>
                                                                    <div> <a class="f-w-500 f-14 "
                                                                            href="product.html">Chain Desktop App</a>
                                                                        <div class="project-comment-icon">
                                                                            <div class="project-link">
                                                                                <svg>
                                                                                    <use
                                                            ...
                                                            <td>
                                                                <div class="product-sub"><a class="f-w-500 f-14 "
                                                                        href="product.html">Eleanor Pena</a><span
                                                                        class="f-w-500 f-light f-12 d-block">pena12@example.com</span>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="product-sub"><a class="f-w-500 f-14 "
                                                                        href="product.html">20 Nov, 2024</a><span
                                                                        class="f-w-500 f-light f-12 d-block">13 Days
                                                                        Left</span></div>
                                                            </td>
                                                            <td>
                                                                <div class="product-sub"><a class="f-w-500 f-14 "
                                                                        href="product.html">Team Suresh</a><span
                                                                        class="f-w-500 f-light f-12 d-block">10
                                                                        Member</span></div>
                                                            </td>
                                                            <td>
                                                                <div
                                                            ...
                                                            <td>
                                                                <div class="product-sub">
                                                                    <div class="dropdown">
                                                                        <div id="dropdownMenuButtonicon12"
                                                                            data-bs-toggle="dropdown"
                                                                            aria-expanded="false" role="menu">
                                                                            <svg class="invoice-icon">
                                                                                <use
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="project-comment  d-flex gap-2">
                                                                    <div class="radial-chart-wrap">
                                                                        <div class="widgetsChart" id="widgetsChart3">
                                                                        </div>
                                                                    </div>
                                                                    <div> <a class="f-w-500 f-14 "
                                                                            href="product.html">Business Web Design</a>
                                                                        <div class="project-comment-icon">
                                                                            <div class="project-link">
                                                                                <svg>
                                                                                    <use
                                                            ...
                                                            <td>
                                                                <div class="product-sub"><a class="f-w-500 f-14 "
                                                                        href="product.html">Robert Fox</a><span
                                                                        class="f-w-500 f-light f-12 d-block">foxxxx8s@example.com</span>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="product-sub"><a class="f-w-500 f-14 "
                                                                        href="product.html">22 Nov, 2024</a><span
                                                                        class="f-w-500 f-light f-12 d-block">15 Days
                                                                        Left</span></div>
                                                            </td>
                                                            <td>
                                                                <div class="product-sub"><a class="f-w-500 f-14 "
                                                                        href="product.html">Team Liza</a><span
                                                                        class="f-w-500 f-light f-12 d-block">7
                                                                        Member</span></div>
                                                            </td>
                                                            <td>
                                                                <div
                                                            ...
                                                            <td>
                                                                <div class="product-sub">
                                                                    <div class="dropdown">
                                                                        <div id="dropdownMenuButtonicon13"
                                                                            data-bs-toggle="dropdown"
                                                                            aria-expanded="false" role="menu">
                                                                            <svg class="invoice-icon">
                                                                                <use
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="project-comment  d-flex gap-2">
                                                                    <div class="radial-chart-wrap">
                                                                        <div class="widgetsChart" id="widgetsChart4">
                                                                        </div>
                                                                    </div>
                                                                    <div> <a class="f-w-500 f-14 "
                                                                            href="product.html">NFT App Design</a>
                                                                        <div class="project-comment-icon">
                                                                            <div class="project-link">
                                                                                <svg>
                                                                                    <use
                                                            ...
                                                            <td>
                                                                <div class="product-sub"><a class="f-w-500 f-14 "
                                                                        href="product.html">Arlene McCoy</a><span
                                                                        class="f-w-500 f-light f-12 d-block">arlene78@example.com</span>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="product-sub"><a class="f-w-500 f-14 "
                                                                        href="product.html">28 Nov, 2024</a><span
                                                                        class="f-w-500 f-light f-12 d-block">21 Days
                                                                        Left</span></div>
                                                            </td>
                                                            <td>
                                                                <div class="product-sub"><a class="f-w-500 f-14 "
                                                                        href="product.html">Team Sulekha</a><span
                                                                        class="f-w-500 f-light f-12 d-block">9
                                                                        Member</span></div>
                                                            </td>
                                                            <td>
                                                                <div
                                                            ...
                                                            <td>
                                                                <div class="product-sub">
                                                                    <div class="dropdown">
                                                                        <div id="dropdownMenuButtonicon14"
                                                                            data-bs-toggle="dropdown"
                                                                            aria-expanded="false" role="menu">
                                                                            <svg class="invoice-icon">
                                                                                <use
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="project-comment  d-flex gap-2">
                                                                    <div class="radial-chart-wrap">
                                                                        <div class="widgetsChart" id="widgetsChart5">
                                                                        </div>
                                                                    </div>
                                                                    <div> <a class="f-w-500 f-14 "
                                                                            href="product.html">Digital Avtar Web
                                                                            Design</a>
                                                                        <div class="project-comment-icon">
                                                                            <div class="project-link">
                                                                                <svg>
                                                            ...
                                                            <td>
                                                                <div class="product-sub"><a class="f-w-500 f-14 "
                                                                        href="product.html">Courtney Henry</a><span
                                                                        class="f-w-500 f-light f-12 d-block">henry45@example.com</span>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="product-sub"><a class="f-w-500 f-14 "
                                                                        href="product.html">2 Dec, 2024</a><span
                                                                        class="f-w-500 f-light f-12 d-block">25 Days
                                                                        Left</span></div>
                                                            </td>
                                                            <td>
                                                                <div class="product-sub"><a class="f-w-500 f-14 "
                                                                        href="product.html">Team Shreena</a><span
                                                                        class="f-w-500 f-light f-12 d-block">12
                                                                        Member</span></div>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <div class="product-sub">
                                                                    <div class="dropdown">
                                                                        <div id="dropdownMenuButtonicon15"
                                                                            data-bs-toggle="dropdown"
                                                                            aria-expanded="false" role="menu">
                                                                            <svg class="invoice-icon">
                                                                                <use
                                                            ...
                                                            <td class="client-list">
                                                                ...
                                                                <div class="user-comment w-100">
                                                                    <div class="product-sub"> <a class="f-14 f-w-500 "
                                                                            ...
                                                                            class="d-block f-light f-w-500">+84 342 556
                                                                            555 </span></div>
                                                                    <div class="product-sub">
                                                                        <svg class="invoice-icon">
                                                                            <use
                                                                                href="../assets/svg/icon-sprite.svg#messages-3">
                                                                            </use>
                                                                        </svg>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            <td class="client-list">
                                                                <div class="user-id">
                                                                    ...
                                                                    <div class="product-sub"><a class="f-14 f-w-500 "
                                                                            href="user-profile.pug">Albert
                                                                            Flores</a><span
                                                                            class="d-block f-light f-w-500">UK</span>
                                                                    </div>
                                                                </div>
                                                                <div class="user-comment w-100">
                                                                    <div class="product-sub"><a class="f-14 f-w-500 "
                                                                            href="user-profile.pug">albert78@gmail.com</a><span
                                                                            class="d-block f-light f-w-500">+77 445 551
                                                                            629</span></div>
                                                                    <div class="product-sub">
                                                                        <svg class="invoice-icon">
                                                                            <use
                                                            ...
                                                            <td class="client-list">
                                                                <div class="user-id">
                                                                    ...
                                                                    <div class="product-sub"><a class="f-14 f-w-500 "
                                                                            ...
                                                                            class="d-block f-light f-w-500">London</span>
                                                                    </div>
                                                                </div>
                                                                <div class="user-comment w-100">
                                                                    <div class="product-sub"> <a class="f-14 f-w-500 "
                                                                            href="user-profile.pug">jane145@gmail.com</a><span
                                                                            class="d-block f-light f-w-500">+56 955 510
                                                                            831</span></div>
                                                                    <div class="product-sub">
                                                                        <svg class="invoice-icon">
                                                                            <use
                                                            ...
                                                            <td class="client-list">
                                                                <div class="user-id">
                                                                    <div class="avatars me-2">
                                                                        <div class="avatar"> <img
                                                                                class="img-50 rounded-circle"
                                                                                src="../assets/images/user/31.png"
                                                                                alt="#"></div>
                                                                    </div>
                                                                    <div class="product-sub"> <a class="f-14 f-w-500 "
                                                                            href="user-profile.pug">Devon Lane</a><span
                                                                            class="d-block f-light f-w-500">America</span>
                                                                    </div>
                                                                </div>
                                                                <div class="user-comment w-100">
                                                                    <div class="product-sub"><a class="f-14 f-w-500 "
                                                                            href="user-profile.pug">devom796@gmail.com</a><span
                                                                            class="d-block f-light f-w-500">+56 955 570
                                                                            095</span></div>
                                                                    <div class="product-sub">
                                                                        <svg class="invoice-icon">
                                                                            <use
                                                            ...
                                                            <td class="client-list">
                                                                <div class="user-id">
                                                                    <div class="avatars me-2">
                                                                        <div class="avatar"><img
                                                                                class="img-50 rounded-circle"
                                                                                src="../assets/images/user/32.png"
                                                                                alt="#"></div>
                                                                    </div>
                                                                    <div class="product-sub"><a class="f-14 f-w-500 "
                                                                            href="user-profile.pug">Cody Fisher</a><span
                                                                            class="d-block f-light f-w-500">Canada</span>
                                                                    </div>
                                                                </div>
                                                                <div class="user-comment w-100">
                                                                    <div class="product-sub"><a class="f-14 f-w-500 "
                                                                            href="user-profile.pug">cody7895@gmail.com</a><span
                                                                            class="d-block f-light f-w-500">+226 795 552
                                                                            31</span></div>
                                                                    <div class="product-sub">
                                                                        <svg class="invoice-icon">
                                                                            <use
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end"
                                                            aria-labelledby="dropdownMenuButtondown"><a
                                                                ...
                                                                class="dropdown-item" href="#">Client </a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="activity-log-card">
                                                <ul>
                                                    ...
                                                    <li class="activity-log">
                                                        <div class="d-flex align-items-start gap-2"><img
                                                                class="activity-log-img rounded-circle img-fluid me-2"
                                                                src="../assets/images/user/34.png" alt="user">
                                                            <div>
                                                                <div class="common-space user-id">
                                                                    <h6> <a class="f-w-500 f-12"
                                                    ...
                                                    <li class="activity-log">
                                                        <div class="d-flex align-items-start gap-2"><img
                                                                class="activity-log-img rounded-circle img-fluid me-2"
                                                                src="../assets/images/user/35.png" alt="user">
                                                            <div>
                                                                <div class="common-space user-id">
                                                                    <h6> <a class="f-w-500 f-12"
                                                                            href="user-profile.html">Seema Joshi</a>
                                                                    </h6><span class="f-light f-w-500 f-12">Today 10:42
                                                                        AM</span>
                                                                </div>
                                                                <div class="d-flex mb-2"><span
                                                                        class="f-light f-w-500 f-12">Meeting : </span><a
                                                                        class="f-w-500 f-12" href="blog.html">Eva
                                                                        Website</a></div><span
                                                    ...
                                                    <li class="activity-log">
                                                        <div class="d-flex align-items-start gap-2"><img
                                                                class="activity-log-img rounded-circle img-fluid me-2"
                                                                src="../assets/images/user/44.png" alt="user">
                                                            <div>
                                                                <div class="common-space user-id">
                                                                    <h6> <a class="f-w-500 f-12"
                                                                            href="user-profile.html">Elara Winter</a>
                                                                    </h6><span class="f-light f-w-500 f-12">Today 06:45
                                                                        AM</span>
                                                                </div>
                                                                <div class="d-flex mb-2"><span
                                                                        class="f-light f-w-500 f-12">Meeting : </span><a
                                                    ...
                                                    <li class="activity-log">
                                                        <div class="d-flex align-items-start gap-2"><img
                                                                class="activity-log-img rounded-circle img-fluid me-2"
                                                                src="../assets/images/user/38.png" alt="user">
                                                            <div>
                                                                <div class="common-space user-id">
                                                                    <h6> <a class="f-w-500 f-12"
                                                                            href="user-profile.html">Arya Shwanno</a>
                                                                    </h6><span class="f-light f-w-500 f-12">Today 05:51
                                                                        AM</span>
                                                                </div>
                                                                <div class="d-flex mb-2"><span
                                                                    ...
                                                                    class="f-light f-w-500 f-12 d-block">Make sure your
                                                                    AI file is cloud storage like Google Drive or
                                                ...
                                                <ul>
                                                    <li>
                                                        <div class="activity-log"><img
                                                                class="activity-log-img rounded-circle img-fluid me-2"
                                                                src="../assets/images/user/39.png" alt="user">
                                                            <div class="status bg-warning"></div>
                                                            <div class="activity-name">
                                                                <div>
                                                                    <h6> <a class="f-w-500 f-14"
                                                                            href="user-profile.html">Maren Ross</a></h6>
                                                                    <span class="f-light f-w-500 f-12 ">Hey, What’s
                                                                        today update ?</span>
                                                                </div>
                                                                <div class="product-sub">
                                                                    <div class="dropdown">
                                                    ...
                                                    <li>
                                                        <div class="activity-log"><img
                                                                class="activity-log-img rounded-circle img-fluid me-2"
                                                                src="../assets/images/user/40.png" alt="user">
                                                    ...
                                                    <li>
                                                        <div class="activity-log"><img
                                                                class="activity-log-img rounded-circle img-fluid me-2"
                                                                src="../assets/images/user/41.png" alt="user">
                                                            <div class="status bg-warning"></div>
                                                            <div class="activity-name">
                                                                <div>
                                                                    <h6> <a class="f-w-500 f-14"
                                                    ...
                                                    <li>
                                                        <div class="activity-log"><img
                                                                class="activity-log-img rounded-circle img-fluid me-2"
                                                                src="../assets/images/user/42.png" alt="user">
                                                            <div class="status bg-undefined"></div>
                                                            <div class="activity-name">
                                                                <div>
                                                                    <h6> <a class="f-w-500 f-14"
                                                                            href="user-profile.html">Dianne Russell</a>
                                                                    </h6><span class="f-light f-w-500 f-12 ">So, what is
                                                                        my next work ?</span>
                                                                </div>
                                                                <div class="product-sub">
                                                                    <div class="dropdown">
                                                    ...
                                                    <li>
                                                        <div class="activity-log"><img
                                                                class="activity-log-img rounded-circle img-fluid me-2"
                                                                src="../assets/images/user/43.png" alt="user">
                                                            <div class="status bg-warning"></div>
                                                            <div class="activity-name">
                                                                <div>
                                                                    <h6> <a class="f-w-500 f-14"
                                                        ...
                                                        <div class="activity-log"><img
                                                            ...
                                                            <div class="activity-name">
                                                                <div>
                                                                    <h6> <a class="f-w-500 f-14"
                                                                            href="user-profile.html">Jenny Wilson</a>
                                                                    </h6><span class="f-light f-w-500 f-12 ">Hey, What’s
                                                                        today update ?</span>
                                                                </div>
                                                                <div class="product-sub">
                                                                    <div class="dropdown">
                                                    ...
                                                    <li>
                                                        <div class="activity-log"><img
                                                                class="activity-log-img rounded-circle img-fluid me-2"
                                                                src="../assets/images/user/45.png" alt="user">
                                                            <div class="status bg-warning"></div>
                                                            <div class="activity-name">
                                                                <div>
                                                                    <h6> <a class="f-w-500 f-14"
                                                    ...
                                                    <li>
                                                        <div class="activity-log"><img
                                                                class="activity-log-img rounded-circle img-fluid me-2"
                                                                src="../assets/images/user/15.png" alt="user">
                                                            <div class="status bg-warning"></div>
                                                            <div class="activity-name">
                                                                <div>
                                                                    <h6> <a class="f-w-500 f-14"
                                                                            href="user-profile.html">Ronald Richards</a>
                                                                    </h6><span class="f-light f-w-500 f-12 ">Thank you
                                                                        !!!</span>
                                                                </div>
                                                                <div class="product-sub">
                                                                    <div class="dropdown">
                                                    ...
                                                    <li>
                                                        <div class="activity-log"><img
                                                                class="activity-log-img rounded-circle img-fluid me-2"
                                                                src="../assets/images/user/47.png" alt="user">
                                                            <div class="status bg-undefined"></div>
                                                            <div class="activity-name">
                                                                <div>
                                                                    <h6> <a class="f-w-500 f-14"
                                                                            href="user-profile.html">Courtney Henry</a>
                                                                    </h6><span class="f-light f-w-500 f-12 ">No, you’ve
                                                                        to do one more variant.</span>
                                                                </div>
                                                                <div class="product-sub">
                                                                    <div class="dropdown">
